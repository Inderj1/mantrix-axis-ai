terraform {
  ...
  # backend "s3" {
  #   bucket = "mantrix-terraform-state"
  #   key    = "minimal-deployment/terraform.tfstate"
  #   region = "us-east-1"
  # }
}
...
module "vpc" {
  ...
  single_nat_gateway   = true  # Cost optimization for minimal deployment
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:secretsmanager:${var.aws_region}:*:secret:mantrix/*"
      }
    ]
  })
}
